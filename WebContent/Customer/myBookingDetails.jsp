...
.col2 h2 {
	background: url(/FlightReservation/img/takeoff.png) no-repeat center 3px;
}
.col4 h2 {
	background: url(/FlightReservation/img/land.png) no-repeat center 3px;
}
...
.terminal {display: block; background: url('/FlightReservation/img/location.png') no-repeat center;font-size: 14px;color:#26a1e4;cursor: pointer;}
				...
				<div class="flightInfo">
					...
					try {
						...
						while(result.next()){
							...
							depAirportName = result.getString(14);
							...
							pageContext.setAttribute("depAirportName", depAirportName);
					%>
					...
					<div class="row from-to-det">
						<div class="col1">
							<img src="/FlightReservation/img/airplane.png" alt=""/>
						...
						<div class="col2">
							...
							<div class="separator"></div>
							<span class="airport"><%= pageContext.getAttribute("depAirportName") %></span>
						</div>
						<div class="col3">
							<span class="c"><img src="/FlightReservation/img/arrow.png" alt=""/></span>
